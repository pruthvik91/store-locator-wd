                                    ...
                                    <div class="widget">
                                        ...
                                        <div class="widget-content">
                                            ...
                                            <table class="invoice-product-items-table table  table-bordered" id="document-item-list-table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><center>Qty. / Stock</center></th>
                                                        <th><center>Price (Rs)</center></th>
                                                        <th><center>Gst</center></th>
                                                        <th class="discount_field"><center>Discount</center></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr class="product-item-row">
                                                                ...
                                                                <td>
                                                                    <div class="inputlabel_wrapper">
                                                                        <input value="<?php echo $HSC_SAC; ?>" type="text" name="hsccode[]" class="hsccode" placeholder="HSN/SAC" style="width:60px;" maxlength="20" >
                                            ...
                                            <div class="span6 span-md-7  span-sm-7 span-xs-13 row-span-left">
                                                <br>
                                                <h4>Terms &amp; Condition / Additional Note</h4>
...
">
                                                    <table class="table document-total-section">
                                                        <tbody>
                                                            ...
                                                            <?php if (isset($enable_subsidy) && $enable_subsidy == 1) { ?>
                                                                <tr>
                                                                    <td  >
                                                                        <input type="hidden" name="subsidy_title" id="subsidy_title" value="<?php echo $subsidy_title; ?>" />
                                                                        <?php echo $subsidy_title; ?> :
                                                                    </td>
                                                                    <td >
                                                                        <div class="total-controls">
                                                                            <input type="text" name="subsidy_amount" id="subsidy_amount" value="<?php echo $subsidy_amount; ?>" />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="total-controls">
                                                                            <input type="hidden" name="cus_pay_grandtotal" id="cus_pay_grandtotal" value="<?php echo $cus_pay_grandtotal; ?>" />
                                                                            <center><label type="text" name="cus_pay_grandtotal_lable" id="cus_pay_grandtotal_lable" class="cus_pay_grandtotal_lable"></label></center>
            
                                                                            <div class="currency-fields">
                                                                                <center><label type="text" name="currency_cus_pay_grandtotal_lable" id="currency_cus_pay_grandtotal_lable" class="currency_cus_pay_grandtotal_lable"></label></center>
                                                                            </div>
                                                                            <input type="hidden" name="currency_cus_pay_grandtotal" id="currency_cus_pay_grandtotal" value="<?php echo $currency_cus_pay_grandtotal; ?>" />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                            ...
                                                            ?>
                                                                ...
                                                                <input type="hidden" name="cus_pay_grandtotal" id="cus_pay_grandtotal" value="" />
                                                                <input type="hidden" name="currency_cus_pay_grandtotal" id="currency_cus_pay_grandtotal" value="" />
                                                            <?php
                                                            } ?>
                                                            <tr>
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <?php if ((!isset($_GET["invoice_id"]))) { ?>
                                                                <div class="payment-type-section">
                                                                            <input type="radio" id="cash" value="cash" class="payment" name="payment" required>
                                                                            <label for="cash" class="btn btn-payment-type btn-payment-type-cash">CASH</label>            
                                                                            <input type="radio" id="Online" value="online" class="payment" name="payment" required>
                                                            ...
                                                            <?php } else { ?>
                                                                <div class="payment-type-section">
                                                                    <?php if(!empty($payment_type_option)){ $i=0;
                                                                        foreach($payment_type_option as $key=>$val){ $val = ($key =='CREDIT')?'CREDIT':$val; $i++;?>
                                                                            <input type="radio" id="<?php echo $key; ?>" value="<?php echo $val; ?>" class="payment newpaymenttype newpaymentid" name="payment" <?php if ($payment == $val) {echo "checked";} ?> required>
                                                                            <label for="<?php echo $key; ?>" class="btn btn-payment-type btn-payment-type-<?php echo $val; ?>"><?php echo ucfirst(strtolower($key)); ?></label>
                                                                    <?php if($i == 4){break;} }
                                                                    } ?>
                                                                    
                                                                </div>
                                                                
                                                                <div style="margin-top:5px;color: #FF7F74;" class="newpaymenttype">(Payment of old customer will be assign to new customer.)</div>
                                                            
                                                                <input type="hidden"  id="payment" name="payment" value="<?php echo $payment; ?>" class="oldpaymenttype oldpaymentid" readonly />
                                                                <?php
                                                                if ((isset($_GET["invoice_id"])) && ($_GET["invoice_id"] != "")) {
                                                                    echo '<div style="margin-top:5px;color: #FF7F74;" class="oldpaymenttype" >(to change payment type please add payment receipt)</div>';
                                                                }
                                                                ?>
                                                            <?php } ?>
